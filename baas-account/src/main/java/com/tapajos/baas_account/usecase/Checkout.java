...
public class Checkout {
    ...
    public Checkout(AccountRepository accountRepository, TransactionRepository transactionRepository) {
    ...
    public Transaction execute(String accountId, BigDecimal amount, Currency currency, String idempotencyKey) {
        ...
        for (int attempt = 0; attempt < MAX_RETRIES; attempt++) {
            ...
            try {
                ...
                accountRepository.updateBalance(account, account.balance().subtract(amount));
                return tx;
